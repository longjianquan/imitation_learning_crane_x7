...
class CR7 {
	...
	void Move_Goal_Position(double *goal_pose, int ID[JOINT_NUM], double JOINT_MIN[JOINT_NUM], double JOINT_MAX[JOINT_NUM]);	//設定されているgoal positionに移動
	void Move_Offset_Position(int ID[JOINT_NUM]);				//初期位置(出力軸中心角)への移動
