...
static double	LIMIT_SPEED[JOINT_NUM]	=	{	3.00,   2.50,	3.00,	3.00,	4.50,	5.00,	4.00,	4.00};		// 速度の上限値暴れた時ように教師データ収集時より下げている
...
static double M[2][3] = {{2.094457, 1.1505, 1.18337},{2.094457, 1.1505, 1.38337}};
...
void *slave_control(void *)
{
	...
	while(ch == 'p'){
		...
		fprintf( crslave.ffp, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,",a[0],a[1],a[2],a[3],a[4],a[5],a[6]);
		fprintf( crslave.ffp, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,",a[7],a[8],a[9],a[10],a[11],a[12],a[13]);
		fprintf( crslave.ffp, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,",a[14],a[15],a[16],a[17],a[18],a[19],a[20]);
